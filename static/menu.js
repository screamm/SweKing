...
class SwedishGameMenu {
        ...
        const menuHTML = `
            ...
            <div id="mainMenu" class="menu-screen">
                ...
                <div class="menu-buttons">
                    <button class="menu-btn solo-btn" onclick="gameMenu.startSoloGame()">
                        ...
                        <div class="btn-text">
                            <div class="btn-title">SPELA</div>
                            <div class="btn-desc">Klassisk kung-hoppning</div>
                        </div>
                    </button>
            ...
            <div id="howtoMenu" class="menu-screen" style="display: none;">
                ...
                <div class="howto-container">
                    ...
                    <div class="howto-section">
                        <h3>⭐ Utmaningar</h3>
                        <p><strong>Dagliga mål:</strong> Klara olika utmaningar för att tjäna poäng</p>
                        <p><strong>Progressiv svårighet:</strong> Spelet blir svårare ju längre du kommer</p>
                    </div>

                    <div class="howto-section">
                        <h3>🏆 Tävling</h3>
                        <p><strong>Topplista:</strong> Tävla mot andra spelare om högsta poäng</p>
                        <p><strong>Rekord:</strong> Sätt nya personliga rekord och lås upp achievements</p>
                    </div>
                </div>
            </div>
            ...
            <div id="aboutMenu" class="menu-screen" style="display: none;">
                ...
                <div class="about-container">
                    ...
                    <div class="about-section">
                        ...
                        <p><strong>Performance:</strong> Optimerad för alla enheter</p>
                    ...
                    <div class="about-section">
                        ...
                        <p>✅ Prestanda-optimerad spelupplevelse</p>
                        <p>✅ Dagliga utmaningar och achievements</p>
            ...
            <!-- Leaderboard Menu -->
            <div id="leaderboardMenu" class="menu-screen" style="display: none;">
                <div class="menu-header">
                    <h2>🏆 TOPPLISTA</h2>
                    <button class="back-btn" onclick="gameMenu.showMainMenu()">← Tillbaka</button>
                </div>
                <div id="leaderboardContent" class="leaderboard-container">
                    <!-- Topplista kommer laddas här -->
                </div>
            </div>

            <!-- Campaign Menu -->
            <div id="campaignMenu" class="menu-screen" style="display: none;">
                <div class="menu-header">
                    <h2>📚 KAMPANJ MODE</h2>
                    <button class="back-btn" onclick="gameMenu.showMainMenu()">← Tillbaka</button>
                </div>
                <div class="campaign-container">
                    <div class="campaign-info">
                        <h3>🇸🇪 Svenska Äventyr</h3>
                        <p>Följ kungens resa genom Sverige och lär dig om vår historia!</p>
            ...
            <!-- Achievements Menu -->
            <div id="achievementsMenu" class="menu-screen" style="display: none;">
                <div class="menu-header">
                    <h2>🏆 ACHIEVEMENTS</h2>
                    <button class="back-btn" onclick="gameMenu.showMainMenu()">← Tillbaka</button>
                </div>
                <div class="achievements-container">
                    <div class="achievement-info">
                        <h3>🎯 Utmärkelser</h3>
                        <p>Lås upp speciella belöningar genom att klara olika utmaningar!</p>
                        <div class="coming-soon">🚧 Kommer snart! 🚧</div>
                    </div>
                </div>
            </div>
            ...
            <!-- Customization Menu -->
            <div id="customizationMenu" class="menu-screen" style="display: none;">
                <div class="menu-header">
                    <h2>👑 ANPASSA KUNG</h2>
                    <button class="back-btn" onclick="gameMenu.showMainMenu()">← Tillbaka</button>
                </div>
                <div class="customization-container">
                    <div class="customization-info">
                        <h3>🎨 Kungens Garderob</h3>
                        <p>Anpassa kungens utseende med olika outfits och kronor!</p>
                        <div class="coming-soon">🚧 Kommer snart! 🚧</div>
                    </div>
                </div>
            </div>
    ...
    showCustomization() {
        ...
        this.currentView = 'customization';
    }

    hideAllMenus() {
        const menus = ['mainMenu', 'challengesMenu', 'settingsMenu', 'howtoMenu', 'aboutMenu', 'leaderboardMenu', 'campaignMenu', 'achievementsMenu', 'customizationMenu'];
    ...
    showLeaderboard() {
        ...
        this.loadLeaderboardIntoMenu();
        this.currentView = 'leaderboard';
    }

    async loadLeaderboardIntoMenu() {
        ...
        try {
            ...
            if (response.ok) {
                ...
                if (scores.length === 0) {
                    container.innerHTML = `
                        <div class="no-scores">
                            <h3>🏆 Inga poäng ännu!</h3>
                            <p>Bli den första att sätta ett rekord!</p>
                        </div>
                    `;
                    return;
                }
                    ...
                    <div class="leaderboard-list">
                        ${scores.map((score, index) => `
                            <div class="leaderboard-item ${index < 3 ? 'top-three' : ''}">
                                ...
                                <div class="leaderboard-date">${new Date(score.created_at).toLocaleDateString('sv-SE')}</div>
                            </div>
                        `).join('')}
                    </div>
                `;
            } else {
                throw new Error('Kunde inte ladda topplista');
            }
        } catch (error) {
            container.innerHTML = `
                <div class="error-message">
                    <h3>❌ Fel</h3>
                    <p>Kunde inte ladda topplistan. Försök igen senare.</p>
                </div>
            `;
        }
    }
